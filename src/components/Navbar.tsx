...
export default function Navbar() {
  ...
  const links = [
    ...
    { label: tr.nav.work, href: "#services" },
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", flexShrink: 0 }}>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.backgroundColor = "rgba(39,66,255,0.08)";
          }}
          onMouseLeave={(e) => {
        ...
        >
          ...
          >
            ...
            <path
              d="M7 1c-1.5 2-2.5 3.8-2.5 6s1 4 2.5 6M7 1c1.5 2 2.5 3.8 2.5 6S8.5 11 7 13M1 7h12"
